    ...
    <div className="relative bg-brand overflow-hidden pt-40 pb-32 flex flex-col items-center justify-center text-center">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-white text-brand font-bold py-4 px-8 rounded-xl hover:bg-gray-100 transition-colors shadow-lg">
                Partner with Parcelis
            </button>
            <button className="bg-white/10 backdrop-blur-sm text-white hover:bg-white/20 font-bold py-4 px-8 rounded-xl shadow-sm hover:shadow-md transition-all transform hover:-translate-y-1">
                See How It Works
            </button>
        </div>
      </div>
