        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            ...
            <div className="flex flex-col items-start group">
                ...
                <div className="text-gray-600 leading-relaxed text-base space-y-4">
                    ...
                    <p>That combination can be expensive from a margin perspective — and risky from a regulatory one.</p>
                </div>
            </div>
            ...
            <div className="flex flex-col items-start group">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">The Financial Cost: How Self-Insuring Eats Your Margin</h3>
                <div className="text-gray-600 leading-relaxed text-base space-y-4">
                    ...
                    <p className="font-medium text-brand">Parcelis converts that unknown risk into a predictable, fixed cost per protected order.</p>
                </div>
            </div>
             ...
             <div className="flex flex-col items-start group">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">The Regulatory Cost: State-Level Penalties</h3>
                <div className="text-gray-600 leading-relaxed text-base space-y-4">
                    <p>Insurance is one of the most heavily regulated industries. Most states treat “offering protection in exchange for payment” as insurance — and require a license.</p>
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                        <li>Fines per violation (often thousands of dollars each)</li>
                        <li>Strict liability for losses</li>
                        <li>Potential criminal exposure</li>
                    </ul>
                    <p>Multiply that by thousands of shipments, and the theoretical penalty exposure becomes enormous.</p>
                </div>
            </div>
